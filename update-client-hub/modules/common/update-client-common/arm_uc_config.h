...
/* For Mbed, ARM_UC_FEATURE_PAL_FILESYSTEM relies on ARM_UC_FEATURE_PAL_FLASHIAP. */
#if !defined(TARGET_LIKE_MBED) || (defined(ARM_UC_FEATURE_PAL_FLASHIAP) && (ARM_UC_FEATURE_PAL_FLASHIAP == 1))
#define ARM_UC_FEATURE_PAL_FILESYSTEM 1
#endif
#define ARM_UC_FEATURE_PAL_LINUX 1
#define ARM_UC_FEATURE_PAL_RTL8195AM 1
