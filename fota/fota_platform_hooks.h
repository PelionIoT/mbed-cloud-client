 ...
 *
 * \param[in] after_upgrade Indicates whether the FOTA client is being initiated after an attempt to update the firmware image, or as part of a regular boot.
