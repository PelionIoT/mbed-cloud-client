...
#define AUTHORIZATION_PREFIX       TWO_CC('A','U')
...
#define ARM_UC_AUTH_ERR_LIST\
    ENUM_FIXED(AUTH_ERR_FIRST, AUTHORIZATION_PREFIX << 16)\
    ENUM_AUTO(AUTH_ERR_INSTALL_REJECTED)\
    ENUM_AUTO(AUTH_ERR_INSTALL_UNAVAILABLE)\
    ENUM_AUTO(AUTH_ERR_DOWNLOAD_REJECTED)\
    ENUM_AUTO(AUTH_ERR_DOWNLOAD_UNAVAILABLE)\
    ENUM_AUTO(AUTH_ERR_LAST)\
...
#define ARM_UC_FM_ERR_LIST\
    ...
    ENUM_AUTO(FIRM_ERR_PROCESSOR_PARSE_ERROR)\
    ENUM_AUTO(FIRM_ERR_INSUFFICIENT_MEMORY_SPACE)\
