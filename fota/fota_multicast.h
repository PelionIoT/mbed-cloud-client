 ...
 *  - Writes can only start after either ::fota_multicast_node_on_manifest or ::fota_multicast_node_get_ready_for_image were received
 *  - Write offset should be a multiple of the fragment size
 *  - Write size should be a multiple of the the fragment size (except for the last write)
 *
 ...
 * Notes:
 *  - Reads can only start after either ::fota_multicast_node_on_manifest or ::fota_multicast_node_get_ready_for_image were received
 *  - Read offset should be a multiple of the candidate storage read size
 *  - Read size should be a multiple of the the candidate storage read
 *
