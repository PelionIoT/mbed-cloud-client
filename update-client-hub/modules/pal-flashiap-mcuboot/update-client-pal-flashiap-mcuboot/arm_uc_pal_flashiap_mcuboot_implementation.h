...
#ifndef ARM_UC_PAL_FLASHIAP_IMPLEMENTATION_MCUBOOT_H
#define ARM_UC_PAL_FLASHIAP_IMPLEMENTATION_MCUBOOT_H
...
arm_uc_error_t ARM_UC_PAL_FlashIAP_Mcuboot_Initialize(ARM_UC_PAAL_UPDATE_SignalEvent_t callback);
 ...
 */
arm_uc_error_t ARM_UC_PAL_FlashIAP_Mcuboot_Prepare(uint32_t location,
 ...
 *         Returns ERR_INVALID_PARAMETER on reject, and no signal is sent.
 */
arm_uc_error_t ARM_UC_PAL_FlashIAP_Mcuboot_Write(uint32_t location,
                                         uint32_t offset,
 ...
 *         Returns ERR_INVALID_PARAMETER on reject, and no signal is sent.
 */
arm_uc_error_t ARM_UC_PAL_FlashIAP_Mcuboot_Finalize(uint32_t location);
 ...
 */
arm_uc_error_t ARM_UC_PAL_FlashIAP_Mcuboot_Read(uint32_t location,
                                        uint32_t offset,
                                        arm_uc_buffer_t *buffer);
 ...
 *         Returns ERR_INVALID_PARAMETER on reject, and no signal is sent.
 */
arm_uc_error_t ARM_UC_PAL_FlashIAP_Mcuboot_Activate(uint32_t location);
...
#endif // ARM_UC_PAL_FLASHIAP_IMPLEMENTATION_MCUBOOT_H
