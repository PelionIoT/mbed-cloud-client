...
{
    FCC_PAL_VALIDATE_ARGUMENTS((NULLPTR == aes))
...
{
    FCC_PAL_VALIDATE_ARGUMENTS((NULL == aes || (uintptr_t)NULL == *aes))
...
{
    FCC_PAL_VALIDATE_ARGUMENTS((NULLPTR == aes || NULL == key))
...
{
    FCC_PAL_VALIDATE_ARGUMENTS((NULLPTR == aes || NULL == input || NULL == output || NULL == iv))
...
{
    FCC_PAL_VALIDATE_ARGUMENTS((NULLPTR == aes || NULL == input || NULL == output))
...
palStatus_t pal_x509Initiate(palX509Handle_t* x509Cert)
{
    ...
    FCC_PAL_VALIDATE_ARGUMENTS( (NULL == x509Cert))

    return pal_plat_x509Initiate(x509Cert);
#else
    PV_UNUSED_PARAM(x509Cert);
    return FCC_PAL_ERR_NOT_SUPPORTED;
#endif
}
...
{
#if (PAL_ENABLE_X509 == 1)
    FCC_PAL_VALIDATE_ARGUMENTS((NULLPTR == x509Cert || NULL == input))

    return pal_plat_x509CertParse(x509Cert, input, inLen);
#else
    PV_UNUSED_PARAM(x509Cert);
    PV_UNUSED_PARAM(input);
    PV_UNUSED_PARAM(inLen);
    return FCC_PAL_ERR_NOT_SUPPORTED;
#endif
}
...
{
#if (PAL_ENABLE_X509 == 1)
    FCC_PAL_VALIDATE_ARGUMENTS((NULLPTR == x509Cert || NULL == output || NULL == actualOutLenBytes))
...
palStatus_t pal_x509CertVerifyExtended(palX509Handle_t x509Cert, palX509Handle_t x509CertChain, int32_t* verifyResult)
{
    ...
    FCC_PAL_VALIDATE_ARGUMENTS((NULLPTR == x509Cert) || (NULL == verifyResult))
    *verifyResult = 0;
#if (PAL_ENABLE_X509 == 1)
    ...
    if (0 != *verifyResult)
    {
        ...
        *verifyResult = *verifyResult ^ FCC_PAL_ERR_MODULE_BITMASK_BASE; //! in order to turn off the MSB bit.
    }
#endif
    return status;
}
...
{
#if (PAL_ENABLE_X509 == 1)
    FCC_PAL_VALIDATE_ARGUMENTS(NULLPTR == x509Cert);
...
{
#if (PAL_ENABLE_X509 == 1)
    FCC_PAL_VALIDATE_ARGUMENTS((NULLPTR == x509Cert || NULLPTR == *x509Cert))
...
{
    FCC_PAL_VALIDATE_ARGUMENTS((NULLPTR == md))
...
{
    FCC_PAL_VALIDATE_ARGUMENTS((NULLPTR == md || NULL == input))
...
{
    FCC_PAL_VALIDATE_ARGUMENTS((NULLPTR == md || NULL == bufferSize))
...
{
    FCC_PAL_VALIDATE_ARGUMENTS((NULLPTR == md || NULL == output))
...
{
    FCC_PAL_VALIDATE_ARGUMENTS((NULLPTR == md || NULLPTR == *md))
...
{
#if (PAL_ENABLE_X509 == 1)
    FCC_PAL_VALIDATE_ARGUMENTS((NULLPTR == x509 || NULL == hash || NULL == sig))
...
{
    FCC_PAL_VALIDATE_ARGUMENTS((NULL == position || NULL == end || NULL == len))
...
{
    FCC_PAL_VALIDATE_ARGUMENTS((NULL == ctx))
...
{
    FCC_PAL_VALIDATE_ARGUMENTS((NULL == ctx || NULLPTR == *ctx))
...
{
    FCC_PAL_VALIDATE_ARGUMENTS((NULLPTR == ctx || NULL == key))
...
{
    FCC_PAL_VALIDATE_ARGUMENTS((NULLPTR == ctx || NULL == input || NULL == iv || NULL == add || NULL == tag || NULL == output))
...
palStatus_t pal_CtrDRBGInit(palCtrDrbgCtxHandle_t* ctx, const void* seed, size_t len)
{
    ...
    FCC_PAL_VALIDATE_ARGUMENTS((NULL == ctx || NULL == seed))
    ...
    if (FCC_PAL_SUCCESS == status)
    {
        ...
        if (FCC_PAL_SUCCESS != status)
        {
            palStatus_t tmpStatus = FCC_PAL_SUCCESS;
            tmpStatus = pal_CtrDRBGFree(ctx);
            if (FCC_PAL_SUCCESS != tmpStatus)
            {
                FCC_PAL_LOG_ERR("Failed to release CTR-DRBG context %" PRId32 ".", tmpStatus);
            }
        }
    }
...
{
    FCC_PAL_VALIDATE_ARGUMENTS(NULLPTR == ctx)
...
{
    FCC_PAL_VALIDATE_ARGUMENTS((NULLPTR == ctx || NULL == out))
...
{
    FCC_PAL_VALIDATE_ARGUMENTS((NULL == key || NULL == input || NULL == output))
#if PAL_CMAC_SUPPORT
    return pal_plat_cipherCMAC(key, keyLenInBits, input, inputLenInBytes, output);
#else   // no CMAC support
    FCC_PAL_LOG_ERR("CMAC support in PAL is disabled");
    return FCC_PAL_ERR_NOT_SUPPORTED;
#endif 
}
...
{
#if PAL_CMAC_SUPPORT
    FCC_PAL_VALIDATE_ARGUMENTS((NULLPTR == ctx || NULL == input))
...
{
#if PAL_CMAC_SUPPORT
    FCC_PAL_VALIDATE_ARGUMENTS(NULLPTR == ctx || NULLPTR == *ctx || NULL == output || NULL == outLen)
...
{
    FCC_PAL_VALIDATE_ARGUMENTS((NULLPTR == grp || NULLPTR == key || NULL == verified))
...
{
    FCC_PAL_VALIDATE_ARGUMENTS((NULL == key))
...
{
    FCC_PAL_VALIDATE_ARGUMENTS((NULL == key || NULLPTR == *key))
...
{
    FCC_PAL_VALIDATE_ARGUMENTS((NULL == keyHandle) || (key_size== 0));
...
{
    FCC_PAL_VALIDATE_ARGUMENTS((NULL == keyHandle) || (NULLPTR == *keyHandle));
...
{
    FCC_PAL_VALIDATE_ARGUMENTS((NULL == prvDERKey || NULLPTR == key))
...
{
    FCC_PAL_VALIDATE_ARGUMENTS((NULL == pubDERKey || NULLPTR == key))
...
{
    FCC_PAL_VALIDATE_ARGUMENTS(( NULLPTR == ECKeyHandle ))
...
{
    FCC_PAL_VALIDATE_ARGUMENTS(NULL == rawSignature || NULL == derSignatureOut || NULL == derSignatureActSizeOut)
    FCC_PAL_VALIDATE_ARGUMENTS(rawSignatureSize != PAL_ECDSA_SECP256R1_SIGNATURE_RAW_SIZE || derSignatureMaxSize < PAL_ECDSA_SECP256R1_SIGNATURE_DER_SIZE)
...
{
    FCC_PAL_VALIDATE_ARGUMENTS(NULLPTR == privateKeyHanlde || NULL == hash || NULL == outSignature || NULL == actualOutSignatureSize)
...
{
    FCC_PAL_VALIDATE_ARGUMENTS((NULLPTR == publicKeyHandle || NULL == hash || NULL == signature))
...
palStatus_t pal_writePrivateKeyWithHandle(const palKeyHandle_t prvKeyHandle, palECKeyHandle_t ECKeyHandle)
{
    ...
    FCC_PAL_VALIDATE_ARGUMENTS(0 == prvKeyHandle || ECKeyHandle == 0);
...
{
    FCC_PAL_VALIDATE_ARGUMENTS(0 == pubKeyHandle || ECKeyHandle == 0);
...
{
    FCC_PAL_VALIDATE_ARGUMENTS((NULLPTR == key || NULL == derBuffer || NULL == actualSize))
...
{
    FCC_PAL_VALIDATE_ARGUMENTS((NULLPTR == grp))
...
{
    FCC_PAL_VALIDATE_ARGUMENTS((NULL == grp || NULLPTR == *grp))
...
{
    FCC_PAL_VALIDATE_ARGUMENTS((NULLPTR == key))
...
{
    FCC_PAL_VALIDATE_ARGUMENTS((NULLPTR == key || NULL == grpID))
...
{
#if (PAL_ENABLE_X509 == 1)
    FCC_PAL_VALIDATE_ARGUMENTS((NULL == x509CSR))
...
{
#if (PAL_ENABLE_X509 == 1)
    FCC_PAL_VALIDATE_ARGUMENTS((NULLPTR == x509CSR || NULL == subjectName))
...
{
#if (PAL_ENABLE_X509 == 1)
    FCC_PAL_VALIDATE_ARGUMENTS((NULLPTR == x509CSR || NULLPTR == pubKey))
...
{
#if (PAL_ENABLE_X509 == 1)
    FCC_PAL_VALIDATE_ARGUMENTS((NULLPTR == x509CSR))
...
{
#if (PAL_ENABLE_X509 == 1)
    FCC_PAL_VALIDATE_ARGUMENTS((NULLPTR == x509CSR || NULL == oid || NULL == value))
...
{
#if (PAL_ENABLE_X509 == 1)
    FCC_PAL_VALIDATE_ARGUMENTS((NULLPTR == x509CSR || NULL == derBuf))
...
{
#if (PAL_ENABLE_X509 == 1)
    FCC_PAL_VALIDATE_ARGUMENTS((0 == x509Cert || 0 == x509CSR || NULL == derBuf || NULL == actualDerBufLen))
...
{
#if (PAL_ENABLE_X509 == 1)
    FCC_PAL_VALIDATE_ARGUMENTS((NULL == x509CSR || NULLPTR == *x509CSR))
...
{
    FCC_PAL_VALIDATE_ARGUMENTS((NULLPTR == grp || NULLPTR == peerPublicKey || NULLPTR == privateKey || NULLPTR == outKey))
    ...
    size_t                      *rawSharedSecretActSizeOut)
{
    ...
    FCC_PAL_VALIDATE_ARGUMENTS(( NULLPTR == derPeerPublicKey || NULLPTR == privateKeyHandle || NULLPTR == rawSharedSecretOut || NULLPTR == rawSharedSecretActSizeOut))
...
{
    FCC_PAL_VALIDATE_ARGUMENTS((NULLPTR == grp || NULLPTR == prvKey || NULL == dgst || NULL == sig || NULL == sigLen))
...
{
    FCC_PAL_VALIDATE_ARGUMENTS((NULLPTR == pubKey || NULL == dgst || NULL == sig || NULL == verified))
...
palStatus_t pal_x509CertGetHTBS(palX509Handle_t x509Cert, palMDType_t hash_type, unsigned char *output, size_t outLenBytes, size_t* actualOutLenBytes)
{
    ...
    FCC_PAL_VALIDATE_ARGUMENTS((NULL == output || NULL == actualOutLenBytes || NULLPTR == x509Cert));
