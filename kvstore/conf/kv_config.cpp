...
#if COMPONENT_EXTERNAL_BLOCKDEVICE
#include "ExternalBlockDevice.h"
#endif

#if !defined(MBED_CONF_STORAGE_TDB_INTERNAL_INTERNAL_BASE_ADDRESS)
#define MBED_CONF_STORAGE_TDB_INTERNAL_INTERNAL_BASE_ADDRESS 0xFFFFFFFF
#endif

#if !defined(MBED_CONF_STORAGE_TDB_INTERNAL_INTERNAL_SIZE)
...
int _get_flashiap_bd_default_addresses_tdb_internal(bd_addr_t *start_address, bd_size_t *size)
{
    ...
    assert(curr_addr >= first_wrtbl_sector_addr);
...
BlockDevice* _get_blockdevice_EXTERNAL_BLOCKDEVICE(bd_addr_t start_address, bd_size_t size)
{
#if COMPONENT_EXTERNAL_BLOCKDEVICE
    bd_addr_t aligned_end_address;
    bd_addr_t aligned_start_address;
...
#if defined (MBED_CONF_STORAGE_TDB_EXTERNAL_EXTERNAL_BLOCK_DEVICE) || defined(MBED_CONF_STORAGE_FILESYSTEM_BLOCKDEVICE)
...
#endif // (MBED_CONF_STORAGE_TDB_EXTERNAL_EXTERNAL_BLOCK_DEVICE) || defined(MBED_CONF_STORAGE_FILESYSTEM_BLOCKDEVICE)
