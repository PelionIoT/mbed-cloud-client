...
*/
    ...
    * RBP items behave differently during factory reset and therefore passed as a separate type to KSA. It shouldn't collide with KCM Item types.
    */
    typedef enum {
...
*/
    ...
    *                                       This variable will be set to the corresponding storage location as defined in `::kcm_item_location_e`
    *    @returns
    *        ::KCM_STATUS_SUCCESS            in case of success.
