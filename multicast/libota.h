...
#define OTA_FRAGMENT_CMD_LENGTH         21
#define OTA_END_FRAGMENTS_CMD_LENGTH    17
#define OTA_FRAGMENTS_REQ_LENGTH        18
...
typedef enum
{
    ...
    OTA_CMD_START,
    OTA_CMD_FRAGMENT,
    OTA_CMD_END_FRAGMENTS,
    OTA_CMD_FRAGMENTS_REQUEST,
    OTA_CMD_ABORT
} ota_commands_e;
...
typedef enum
{
    ...
    OTA_FALLBACK_TIMER,
    OTA_MULTICAST_MSG_SENT_TIMER,
    OTA_MULTICAST_MANIFEST_MSG_SENT_TIMER,
...
static ota_error_code_e ota_send_multicast_command(ota_commands_e command, uint8_t *payload_ptr, uint16_t payload_length);
