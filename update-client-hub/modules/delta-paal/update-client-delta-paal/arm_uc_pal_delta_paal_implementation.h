...
#ifndef ARM_UC_PAL_DELTA_PAAL_IMPLEMENTATION_H
#define ARM_UC_PAL_DELTA_PAAL_IMPLEMENTATION_H
...
/**
 * @brief Set PAAL Storage module implementation which Delta-Paal is meant to use.
 *
...
#endif /* ARM_UC_PAL_DELTA_PAAL_IMPLEMENTATION_H */
