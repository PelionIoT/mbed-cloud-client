...
#ifndef PAL_NXP_CONFIGURATION_H_
#define PAL_NXP_CONFIGURATION_H_

/*! \brief This file sets configuration for PAL porting on MCUXpresso SDK.
...
//!< Max given token for a semaphore
    ...
    #define PAL_SEMAPHORE_MAX_COUNT 510
#endif
